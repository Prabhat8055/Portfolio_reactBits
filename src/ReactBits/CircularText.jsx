...
const CircularText = ({
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`mx-auto rounded-full w-[80px] h-[80px] text-white font-black text-center cursor-pointer origin-center ${className} hover:text-[#ff0055eb]`}
      animate={controls}
    ...
    >
      {letters.map((letter, i) => {
        ...
        return (
          <span
            key={i}
            className="absolute inline-block inset-0 text-[10px] font-bold transition-all duration-500 ease-[cubic-bezier(0,0,0,1)] "
